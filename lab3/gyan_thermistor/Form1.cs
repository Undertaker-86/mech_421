...
namespace GyanThermistor
{
    public partial class Form1 : Form
    {
        ...
        private static readonly Color BaseBackColor = Color.FromArgb(27, 30, 39);
        private static readonly Color PanelBackColor = Color.FromArgb(33, 36, 48);
        private static readonly Color FieldBackColor = Color.FromArgb(40, 43, 54);
        private static readonly Color AccentRefreshColor = Color.FromArgb(62, 70, 92);
        private static readonly Color AccentBlueColor = Color.FromArgb(0, 120, 212);
        private static readonly Color AccentGreenColor = Color.FromArgb(0, 153, 116);
        private static readonly Color AccentOrangeColor = Color.FromArgb(255, 140, 0);
        private static readonly Color AccentRedColor = Color.FromArgb(192, 57, 43);
        private static readonly Color StatusInfoColor = Color.FromArgb(102, 193, 255);
        ...
        private Label CreateFieldLabel(string text, Padding? margin = null)
        {
            return new Label
            {
                Text = text,
                ...
                Margin = margin ?? new Padding(3, 6, 3, 6)
            };
        }

        private TextBox CreateReadOnlyField(bool rightAlign = true, Padding? margin = null)
        {
            return new TextBox
            {
                ...
                ReadOnly = true,
                Dock = DockStyle.Fill,
                Margin = margin ?? new Padding(0, 3, 0, 6),
                TextAlign = rightAlign ? HorizontalAlignment.Right : HorizontalAlignment.Left
            };
        }

        private TextBox CreateEditableField(string text, Padding? margin = null)
        {
            return new TextBox
            {
                Text = text,
        ...
        private Button CreateAccentButton(string text, Color backColor, Padding? margin = null)
        {
            Button button = new Button
            {
                ...
                Dock = DockStyle.Fill,
                Margin = margin ?? new Padding(0, 6, 0, 6)
            };
