...
static void start_pwm(void) {
    // Re-enable peripheral function before starting
    P3SEL0 |= BIT4;
    P3SEL1 &= ~BIT4;
    TB1CCTL1 = OUTMOD_7;
...
int main(void) {
    ...
    uart_puts("\r\nMSP430FR5739 Final Packet Control\r\n");
    uart_puts("Commands: 0x01=set freq, 0x04=set duty, 0x05=stop, 0x02=LED ON, 0x03=LED OFF\r\n");
