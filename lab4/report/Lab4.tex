...
My C\# program has an inbuilt curve fit function. The voltage-to-distance data were fitted with a smooth function (e.g., inverse power). Plotting both the raw scatter and the fitted curve in the report allowed visual confirmation that the model captured the sensor response with minimal residual error.
