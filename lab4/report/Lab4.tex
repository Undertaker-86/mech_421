...
\begin{enumerate}
    ...
    \item Design and assemble the photodiode transimpedance amplifier by selecting $R_2$ to convert a \SI{1}{\micro\ampere} photocurrent into a \SI{100}{\milli\volt} deviation about a bias voltage $V_1$.
...
\begin{enumerate}
    \item Design and build a second RC high-pass filter using $C_3$ and $R_9$ with the same cutoff frequency as the first stage to further suppress low-frequency ambient-light variations.
...
\section{The Importance of Alignment with Photodiode and LED}
