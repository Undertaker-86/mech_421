// main.c -- Thermistor ADC produces 3-byte frames (255, MS5B, LS5B)
// Source: lab3/Ryan_part1ex2/main.c (exported for Appendix C)
#include <msp430.h>
#include <stdint.h>
...
static void gpio_init(void) {
    // Route P1.4 to ADC10 A4 (datasheet shows P1.4/TB0.1/UCA0STE/A4)
    P1DIR  &= ~BIT4;
    P1SEL0 |=  BIT4;
    P1SEL1 |=  BIT4;
