...
namespace ex4
{
    public partial class Form1 : Form
    {
        ...
        private struct AccelerometerDataPoint
        {
            public double timestamp;
            public int ax, ay, az;
        }

        private List<AccelerometerDataPoint> recorded_data = new List<AccelerometerDataPoint>();
                ...
                switch (current_state)
                {
                    ...
                    case ParseState.waiting_for_az:
                        { 
                            ...
                            // If all 3 were read, save data point to array
                            var data_point = new AccelerometerDataPoint
                            {
        ...
        private void buttonSelectFile_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.Title = "Save Accelerometer Data";
        ...
        private void ButtonSaveFile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No data has been recorded",
                                "No Data",
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Error);
                return;
            ...
            try
            {
                using (StreamWriter file = new StreamWriter(textBoxFilename.Text))
                {
                    file.WriteLine("Time(s), Ax, Ay, Az");

                    foreach (var data_point in recorded_data)
                    {
                        string line = $"{data_point.timestamp}, {data_point.ax}, {data_point.ay}, {data_point.az}";
                        file.WriteLine(line);
                    }
                }

                MessageBox.Show($"Successfully saved {recorded_data.Count} data to:\n{textBoxFilename.Text}",
                                "Save Successful",
                                MessageBoxButtons.OK,
            ...
            {
                MessageBox.Show($"Error occured when saving file with Error: {ex}",
                                "File Save Error",
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Error);
            }
