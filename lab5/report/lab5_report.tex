...
\subsubsection{Gantry Mechanism}
\begin{figure}[H]
  \centering
  \IfFileExists{figures/ex3_gantry.png}{%
    \includegraphics[width=0.8\textwidth]{figures/ex3_gantry.png}%
  }{%
    \fbox{\parbox{0.75\textwidth}{Gantry sketch/assembly (add \texttt{figures/ex3\_gantry.png}) showing X/Y rails, carriage, and pen holder.}}%
  }
  \caption{Gantry arrangement: orthogonal rails with pen carriage}
  \label{fig:ex3-gantry}
\end{figure}
...
When we trid to draw Deku however, the result was not as expected. The image was too complex and perhaps it required more advanced path planning or 
